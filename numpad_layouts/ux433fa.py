...
keys = [
    ...
    [ecodes.KEY_KP1, ecodes.KEY_KP2, ecodes.KEY_KP3, ecodes.KEY_KPMINUS, ecodes.KEY_KPENTER],
    [ecodes.KEY_KP0, ecodes.KEY_KP0, ecodes.KEY_KPDOT, ecodes.KEY_KPPLUS, ecodes.KEY_KPENTER]
]
